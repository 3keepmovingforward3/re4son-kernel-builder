...
export DEBFULLNAME=TempleEngineering
export DEBEMAIL=ieee@temple.edu

UNAME_STRING7="${VERSION}-Temple-v7+"
UNAME_STRING8="${VERSION}-Temple-v8+"
...
while getopts "hb:cnpexr:7:8:" opt; do
  case "$opt" in
  h)  usage
      exit 0
      ;;
